...
public class HouseRobberIIITest {
    ...
    private HouseRobberIII target = new HouseRobberIII();

    @Test
    public void rob() {
        TreeNode root = TreeNode.buildFrom(new Integer[]{
                3,2,3,null,3,null,1
        });
        root = TreeNode.buildFrom(new Integer[]{
        ...
        assertEquals(3038, target.rob(root));
